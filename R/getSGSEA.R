...
#' @description This function can perform the Survival-based Gene Set Enrichment Analysis (SGSEA) based on the survival statistics, log hazard ratios, and the typical case vs. control (or normal vs. tumor) GSEA. This function uses the fgsea function from fgsea package.
