...
#' @description Return a numeric vector of log hazard ratios with corresponding gene symbols as their names. This function is calling coxph function from the survival package.
#' @param normalizedData A data frame contains the normalized counts. Rows must be the sample IDs. Columns must be the unique gene symbols. Data should be filtered and normalized before entering this step. See KIRC data included in this package as the input example format.
